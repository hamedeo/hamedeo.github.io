...
Karen E. Fields and Barbara J. Fields describe a similar process in Racecraft. They examine the familiar statement:

<p class="article-quotation">“Black Southerners were segregated because of their skin color.”</p>

The sentence sounds descriptive, but its grammar conceals the people and institutions that imposed segregation. An organized system of exclusion reappears as though it were a consequence of the people being excluded. Racist action produces the apparent reality of race, and then race is presented as the explanation for that action.[^1]

![Bahman Mohassess's Il Minotauro fa Paura alla Gente per Bene, depicting a dark minotaur-like figure](./Pics/Il-Minotauro-fa-Paura-alla-Gente-per-Bene.jpeg "class\:article-image article-image--full")
...
![Diagram showing a narrow compliance clause expanding into broad gatekeeping based on nationality](./Pics/Exclusion-and-Nationality.png "class\:article-image article-image--full")

<small class="article-image-credit">Excerpt from a publicly available high-tech vacancy. When a narrow compliance clause becomes a broader gatekeeping tool. Source anonymized to keep the focus on the practice.</small>

Yet once nationality restrictions become normalized, their effects can spread beyond the original position. A hiring manager may reject someone because a future client might object. A secondment agency may decide that an Iranian candidate is harder to place. Contractors and subcontractors may adopt stricter internal rules than their clients or the law actually require. One Dutch ruling concerned precisely such a situation: an Iranian applicant was rejected by a technical secondment agency after broad references to clients working with American companies, without a demonstrated legal exception for the position.[^5]

> **A narrow compliance rule can become a system of exclusion after its original justification is no longer examined.**

This is not merely an inference. In separate recruitment processes, I was told that I was suitable for an interview but could not be presented to a client as a “doubtful candidate”; my nationality was described as a hiring “block”; and a recruiter said that a company would not proceed because it did not want to “take the risk,” even though some projects were acknowledged to be accessible. At a career fair in Delft, after I asked whether such a policy existed, a company representative also told me directly that they would not hire me because they wanted to “protect themselves.” Knowledge-security screening has also appeared in PhD recruitment at Dutch universities and research institutions.[^6] These are only some of the instances in which the reason was stated openly. In many other cases, the process simply ended without explanation.

At that point, exclusion becomes institutionalized. It is no longer reconsidered for each person or position, but reproduced through routines, internal policies and anticipated client preferences.

The Netherlands has long cultivated a reputation for tolerance, equal treatment and openness to international talent. Its history should make Dutch employers and institutions especially alert to the moment when individual assessment gives way to collective suspicion and exclusion becomes normalized through administrative procedure.
...
One way to prevent automatic discrimination is to assess candidates first on merit and then conduct a documented, role-specific compliance review. Companies should require recruitment partners to consider licensing, access controls and alternative responsibilities, and should reward them for finding lawful solutions for qualified candidates who might otherwise be excluded through blanket screening.

Nationality screening may sometimes satisfy a specific legal obligation, but it should not be confused with a complete security assessment. Information can be compromised by people of any nationality. Effective protection also requires controlled access, monitoring and individual accountability.[^8] When that distinction is lost, a narrow compliance measure can become systemic: copied across organizations, widened beyond its original purpose and reused as a general tool of exclusion.

> **Iranian citizens are not extensions of the Iranian government.**

In fact, many are among those most directly harmed by its decisions.[^9] When institutions abroad impose additional burdens on them, those decisions should be named without turning “Iranian” into an explanation for exclusion.

### A Short Note to Academia: Restricting the Body of Knowledge

Universities are supposed to question assumptions, not automate them. When academic institutions treat candidates as compliance risks and administrative burdens before assessing their ideas and abilities, they stop acting as institutions of inquiry and start acting as risk managers. Academia loses its soul when protecting institutional comfort matters more than pursuing knowledge.

This applies not only to who can access knowledge, but also to who is allowed to help create it.
...
>
> **— Albert Einstein, foreword to Lincoln Barnett’s The Universe and Dr. Einstein (1948)**
...
We are not rejected by our nationality. People and institutions exclude us through decisions made about it, and those decisions must remain visible and open to challenge.
...
[^3]: Government of the Netherlands, [Prohibition of discrimination](https://www.government.nl/themes/migration-and-travel/discrimination/prohibition-of-discrimination). Dutch law recognizes nationality as a protected ground and prohibits unequal treatment under equal circumstances.

[^4]: Netherlands Institute for Human Rights, [Ruling 2025-49](https://oordelen.mensenrechten.nl/oordeel/2025-49/132a89f8-0a5c-4fd6-9ab1-aefd8b904d80), where an applicant was unlawfully excluded based on an unverified assumption about security screening; and [Ruling 2026-42](https://oordelen.mensenrechten.nl/oordeel/2026-42/03a1c1ef-1799-4449-94d8-6dc84786be0a), where a narrowly defined nationality restriction was accepted after the employer demonstrated a concrete conflict with US export-control requirements.

[^5]: Netherlands Institute for Human Rights, [Ruling 2020-8](https://oordelen.mensenrechten.nl/oordeel/2020-8). A technical secondment agency unlawfully rejected an Iranian applicant after referring broadly to clients that worked with American companies, without demonstrating that a legal exception applied to the position.

[^6]: Eindhoven University of Technology, current PhD vacancy notices including [“PhD in Safe AI-based Control”](https://www.tue.nl/werken-bij-tue/vacatureoverzicht/phd-in-safe-ai-based-control) and [“PhD in Post-Quantum Cryptography”](https://www.tue.nl/en/working-at-tue/vacancy-overview/phd-in-post-quantum-cryptography). Both state that a pre-employment screening, such as a knowledge-security check, may form part of the selection procedure. See also the Dutch Government’s [National Knowledge Security Guidelines](https://english.loketkennisveiligheid.nl/site/binaries/site-content/collections/documents/2022/04/07/national-knowledge-security-guidelines/National%2BKnowledge%2BSecurity%2BGuidelines.pdf), published in 2022.
...
[^8]: UK National Cyber Security Centre, [Reducing Data Exfiltration by Malicious Insiders](https://www.ncsc.gov.uk/guidance/reducing-data-exfiltration-by-malicious-insiders). The guidance recommends organizational, procedural and technical controls for preventing, monitoring and auditing unauthorized access and data extraction.

[^9]: UN Office of the High Commissioner for Human Rights, [Iran: Government Continues Systematic Repression and Escalates Surveillance](https://www.ohchr.org/en/press-releases/2025/03/iran-government-continues-systematic-repression-and-escalates-surveillance).
